...
def main(self):
	sf.RenderWindow window(sf.VideoMode(500, 500), "SFML worksnot ")
	...
	sf.Font font
	if not font.loadFromFile("./Data/Fonts/orbitron-light.ttf"):
	...
	{	sf.Event event
		...
		{	if event.type == sf.Event.Closed:
			...
			{	if event.mouseButton.button == sf.Mouse.Button.Left:
				{	input_click = sf.Mouse.getPosition(window)
